...
export const ALPHA_STRATEGIES = {
  ...
  micro:       { label:"رعد التعلم السريع (Blitz)", desc:"تدفق مكثف للمعلومات في دقيقتين يتبعه استراحة نشطة" },
  multimedia:  { label:"الانغماس الحسي والبصري",   desc:"دمج الأصوات والمشاهد في تحليل النصوص العربية" },
  digital_story:{ label:"السرد القصصي الإبداعي",   desc:"تحويل القواعد النحوية لشخصيات في قصة يبنيها الطلاب" },
  peer:        { label:"المعلم الصغير (جيل ألفا)",  desc:"تبادل الأدوار وشرح جزء بسيط لزميل بأسلوب حديث" },
  ...
  scaffold:    { label:"البناء المعرفي الموجه",     desc:"تفكيك المهارة لخطوات صغيرة ملموسة بنجاحات متكررة" },
};
